...
public class SampleController {
    ...
    // Model 과 RedirectAttribute 차이점 : 움직이는 방식 / 객체를 담을 수 있느냐? 없느냐?
    ...
    // log.info("calc 요청 - 사용자 입력값 요청");
    // log.info("{} + {} = {}", calcDto.getNum1(), calcDto.getNum2(),
    // (calcDto.getNum1() + calcDto.getNum2()));
    ...
    // public void postcalc1(int num1, String op, int num2) {
    // log.info("calc 요청 - 사용자 입력값 요청");
